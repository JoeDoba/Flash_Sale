...
public class SeckillActivityController {
    ...
    @Autowired
    public SeckillActivityController(ActivityDao activityDao) {
...
//        resultMap.put("seckillPrice", activity.getSeckillPrice());
//        resultMap.put("oldPrice", activity.getOldPrice());
